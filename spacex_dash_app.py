...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000, 
                                                marks={0: '0', 5000: '5000', 10000: '10000'}, value=[min_payload, max_payload]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        site_df = filtered_df[filtered_df['Launch Site']==entered_site].groupby(['Launch Site','class']).size().reset_index(name='count')
        fig = px.pie(site_df, 
